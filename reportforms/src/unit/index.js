// import { DataFrame, readExcel, toCSV, toExcel, readCSV, toJSON } from 'danfojs-node'
...
//  */
// async function readFromSource(type, fileName, options) {
//     switch (type) {
//         case 'sqlite':
//             {
...
//  * @returns
//  */
// function filterData(data, column, pattern) {
...
// function importPatternsFromJson(fileName) {
//     if (fileName.endsWith('.json')) {
//         let patterns = require(fileName)
//     }
// }

// function exportToFile(type, filePath, df, options) {
//     try {
//         switch (type) {
//             case 'excel':
//                 {
